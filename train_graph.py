...
if __name__ == '__main__':
    ...
    data_loader = get_dataloader(dataset, batch_size=32, random_split_flag=False,
                                 data_split_ratio=[0.8, 0.1, 0.1], seed=100)
    print(data_loader.keys())
    print("Number of training samples:", len(data_loader['train'].dataset))
    print("Number of validation samples:", len(data_loader['eval'].dataset))
    print("Number of test samples:", len(data_loader['test'].dataset))

    batch_val = 32
    # count=0
    # for batch in data_loader['train']:
    #   count+=1
    #   print("Batch size:", batch.x.size(0))
    # print(count)
